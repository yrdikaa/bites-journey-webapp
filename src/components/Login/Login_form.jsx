...
const Login_form = () => {
  ...
  return (
    <div className="rounded-xl bg-white dark:bg-gradient-to-r from-purple-900 to-blue-950  ring-2 ring-blue-500 bg-opacity-50 px-16 py-10 shadow-lg backdrop-blur-md max-sm:px-8">
