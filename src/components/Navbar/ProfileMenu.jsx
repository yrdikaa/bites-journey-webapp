        ...
        <div className="navbar relative">
            ...
            </div>
            {
                isProfileDropdownOpen && (
                    <div
                        className="profile-dropdown absolute mt-2 bg-white border border-gray-300 shadow-md p-4 rounded-lg z-10 right-0">
                        {/* Konten dropdown profil Anda di sini */}
                        <Link href="/Profile" >
                            Profil Saya
                        </Link>
                        <Link href="/create-article" className='block sm:hidden'>
                            Create Article
                        </Link>
